...
class WooProductGrid extends Block {
	...
	protected $frontend_styles  = array( 'essential-blocks-fontawesome', 'essential-blocks-frontend-style' );
		...
		Helper::views(
			...
			array_merge(
				...
				array(
					...
					'loadMoreOptions' => isset( $attributes['loadMoreOptions'] ) ? $attributes['loadMoreOptions'] : array(),
					'queryData'       => $args,
				)
			)
		);
